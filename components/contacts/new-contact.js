...
export const NewContact = () => {
    ...
    const savePatientHandler = async (event) => {
        ...
        const patient = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/contacts/create`, {
            method: "POST",
            headers: {
    ...
    return (
        <div className="modal fade" id="contactModal" tabIndex="-1" aria-labelledby="patientModalLabel" aria-hidden="true">
